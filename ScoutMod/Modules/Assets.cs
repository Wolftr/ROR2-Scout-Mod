...
namespace ScoutMod.Modules
{
    internal static class Assets
    {
        ...
        // projectiles
        internal static GameObject sandmanBaseball;
        ...
        // CHANGE THIS
        private const string assetbundleName = "scouttf2assetbundle";
        ...
        internal static void LoadAssetBundle()
        {
            ...
            {
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("ScoutMod." + assetbundleName))
                {
        ...
        {                                                                                                    //likewise
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("ScoutMod.HenryBank.bnk"))
            {
